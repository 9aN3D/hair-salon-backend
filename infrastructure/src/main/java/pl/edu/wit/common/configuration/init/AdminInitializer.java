...
import pl.edu.wit.auth.details.adapter.MongoAuthDetailsRepository;
import pl.edu.wit.auth.details.adapter.model.AuthDetailsDocument;
import pl.edu.wit.user.adapter.MongoUserRepository;
import pl.edu.wit.user.adapter.model.UserDocument;

import static java.time.LocalDateTime.now;
import static pl.edu.wit.auth.details.domain.AuthDetailsRole.ADMIN;
